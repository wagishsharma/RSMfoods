...
| http://marketto.ru/en/tinymce-images-plugin
| 
...
| `FALSE` - otherwise. 
| is_allowed()  is found at plugins/markettoimages/is_allowed.php of your TinyMCE installation.
| 
...
/*-------------------------------------------------------------------
| 
| Maximum image file size. This value can't exceed value set in php.ini.
