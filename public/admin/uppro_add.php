...
if(isset($_POST['submit']))
{
	...
	{  		
				if($_SESSION['fload'])
				{
					...
					$flag = ''; $r = '';
				    $q = "INSERT INTO `tlb_cms`(`tlb_cms_id`, `tlb_cms_title`, `tlb_cms_text`, `tlb_cms_key`) VALUES (null, '$title', '$text', 16)";
				    $r = mysqli_query($dbc,$q);  
					if(!empty($r))
					{
						echo'<span class="successmssg">Content succeessfully added to the website, <br/> <a href=index.php?option=uppro_add>Click to add more</a> <b></span>';
