  ...
  <tr class="thead">
...

	{
		...
		<tr BGCOLOR="'.$bg.'">
		  ...
		  <td width="15%"><a title="File Edit" href="javascript:void(0);" onclick="PopupCenter(\'gallery_edit.php?id='.$row['tlb_cms_id'].'\', \'myPope'.$inc.'\',800,600);">Edit</a> | 
		  <a title="Delete File" href="delete_img.php?id='.$row['tlb_cms_id'].'&action=clogo" onClick="return delconf('.$row['tlb_cms_id'].');">Delete</a></td>
		</tr>';
		$inc=$inc+1;
	}
echo'</table>';
